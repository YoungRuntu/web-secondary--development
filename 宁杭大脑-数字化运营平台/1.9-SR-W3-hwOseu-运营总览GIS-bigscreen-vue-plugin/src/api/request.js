...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3Njg2MDY0NjA2MywidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.HGichOj78PlOKKpxc3gOqhylHfMSZzQp03EuFpOnUhY";
   apiContextPath = "/api";
}
