...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3NzgyNjEwNDEzMiwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.0nLFmfg8JYBWkk7eP6FX7KCTYjByfi1VGpWrf5q_das";
   apiContextPath = "/api";
}
