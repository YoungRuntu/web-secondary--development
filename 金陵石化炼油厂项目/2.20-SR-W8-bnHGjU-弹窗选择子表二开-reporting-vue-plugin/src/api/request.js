...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3NzU1MzM5NDQ5OCwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.9OL6ct3cQDFvR47qSrzLGQGpMFU1cAJoPAYH5v4bAr4";
   apiContextPath = "/api";
}
