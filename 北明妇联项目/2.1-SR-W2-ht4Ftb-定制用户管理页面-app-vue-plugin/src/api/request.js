...
if (process.env.NODE_ENV === "development") {
   document.cookie = "token=eyJhbGciOiJIUzI1NiJ9.eyJsb2dpblRpbWVzdGFtcCI6MTY3NzU5NzEwMTA2NSwidXNlcklkIjoiMTIzNDU2Nzg5MCJ9.4EsFeczFe8SMYOnOJg_kYe1U4WNnNH_vgBNxA1CcIiA";
   apiContextPath = "/api";
}
